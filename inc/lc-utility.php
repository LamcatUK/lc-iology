...
add_shortcode('social_fb_icon', function () {
    ...
    if ($fburl != '') {
        $output = '<a href="' . $fburl . '" target="_blank"><i class="fa-brands fa-facebook-f"></i></a>';
    }
    return $output;
});
add_shortcode('social_ig_icon', function () {
    ...
    if ($igurl != '') {
        $output = '<a href="' . $igurl . '" target="_blank"><i class="fa-brands fa-instagram"></i></a>';
    }
    return $output;
});
add_shortcode('social_tw_icon', function () {
    ...
    if ($twurl != '') {
        $output = '<a href="' . $twurl . '" target="_blank"><i class="fa-brands fa-twitter"></i></a>';
    }
    return $output;
});
add_shortcode('social_li_icon', function () {
    ...
    if ($liurl != '') {
        $output = '<a href="' . $liurl . '" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a>';
    }
    return $output;
});
