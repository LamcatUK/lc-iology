...
<section id="filters" class="row mb-4">
	<div class="col-md-4">
...
<section class="sort">
	<div class="btn-group" id="sorts">
		<button class="button category">Category</button>
		<button class="button asc genus" data-sort-value="genus">Genus <i></i></button>
		<button class="button asc species" data-sort-value="species">Species <i></i></button>
		<button class="button asc variant" data-sort-value="variant">Variant <i></i></button>
		<span class="button enquire">Enquire</span>
	</div>
</section>
<section class="content">
	<ul class='no-transition list-group tb-data table table-sm' id='isotope'>
<?php
